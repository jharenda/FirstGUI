...
public class ResultWindow extends javax.swing.JFrame {
     ...
     */
    public ResultWindow(String temp) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblResult.setFont(new java.awt.Font("Berlin Sans FB", 1, 24)); // NOI18N
        lblResult.setForeground(new java.awt.Color(153, 51, 0));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(88, 88, 88)
                .addComponent(lblResult, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultWindow(temp).setVisible(true);
